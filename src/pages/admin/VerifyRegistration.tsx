    ...
    const verifyUUID = async () => {
      ...
      try {
        ...
        if (
          ...
          toast.info(
            "İstifadəçi artıq qeydiyyatdan keçib. Admin səhifəsinə yönləndirilir..."
          );
        ...
        toast.error(
          error.response?.data?.message ||
            "Link etibarsız və ya vaxtı bitmişdir"
        );
      } finally {
        setIsLoading(false);
      }
    ...
    <div className="register h-screen flex flex-col items-center justify-center gap-7">
      ...
      >
        {({ handleSubmit, setFieldValue, values, errors, touched }) => (
          <form
            className="w-full px-5 lg:w-[500px] grid grid-cols-1 sm:grid-cols-2 gap-6"
            onSubmit={handleSubmit}
          >
            {/* Phone Number */}
            <div className="col-span-1 sm:col-span-2">
              ...
              <ErrorMessage
                name="phoneNumber"
                component="div"
                className="min-h-[20px] text-red-500 text-sm"
              />
            </div>
            ...
            <div className="relative">
              ...
              <button
                type="button"
                className={`w-full h-[50px] border rounded-md px-3 text-start text-[#2D3748] flex items-center justify-start cursor-pointer ${
                  ...
                  <div className="w-[300px] bg-white p-4 rounded-lg shadow-lg relative">
                    ...
                    <div className="flex justify-center mt-3 gap-2">
                      <button
                        ...
                        className="px-4 py-1 bg-gray-400 text-white rounded-md hover:bg-gray-500 cursor-pointer"
                      >
                        Bağla
                      </button>
                      <button
                        ...
                        className="px-4 py-1 bg-[#1a4381] text-white rounded-md hover:bg-[#102c56] cursor-pointer"
                      >
                        Təsdiqlə
                      </button>
                    </div>
