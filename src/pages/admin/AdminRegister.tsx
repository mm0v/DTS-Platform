...
const AdminRegister = () => {
    ...
    const handleSubmit = () => {
        ...
        const requiredFields: Array<keyof typeof formValues> = [
            "name", "surname", "email", "phoneNumber", "dateOfBirth", "password", "confirmPassword"
        ];
            ...
            <form className="w-full px-5 lg:w-[748px] grid grid-cols-1 md:grid-cols-2 gap-x-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        className={`w-full rounded-lg p-3 !focus:outline-none focus:ring-2 transition duration-300 border ${errors.name
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        className={`w-full rounded-lg p-3 !focus:outline-none focus:ring-2 transition duration-300 border ${errors.surname
                            ? "border-red-500 focus:ring-red-500"
                            : "border-[#D1D1D1] focus:border-blue-500"
                            }`}
                    />
                    <div className="min-h-[20px] text-red-500 text-sm">{errors.surname}</div>
                </div>
                ...
                <div className="col-span-2">
                    <label htmlFor="phone" className="block text-sm font-medium mb-1 text-[#2D3748]">Mobil nömrə</label>
                    <PhoneInput
                        ...
                        countrySelectorStyleProps={{
                            className: "react-international-phone-country-selector text-black"
                        }}
                    />

                    <div className="min-h-[20px] text-red-500 text-sm">{errors.phoneNumber}</div>
                </div>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        className={`w-full rounded-lg p-3 !focus:outline-none focus:ring-2 transition duration-300 border ${errors.password
                            ? "border-red-500 focus:ring-red-500"
                            : "border-[#D1D1D1] focus:border-blue-500"
                            }`}
                    />
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        className={`w-full rounded-lg p-3 !focus:outline-none focus:ring-2 transition duration-300 border ${errors.confirmPassword
                            ? "border-red-500 focus:ring-red-500"
                            : "border-[#D1D1D1] focus:border-blue-500"
                            }`}
                    />
