...
const ApplyThree = () => {
  ...
  const validateForm = () => {
    const newErrors = {
      ...
      companyPurpose: formData.digitalReadiness.companyPurpose.trim().length < 3,
    }
    setErrors(newErrors)
  ...
  const handleInputChange = (e: ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    setErrors(prev => ({
      ...prev,
      [name]: name === "digitalLevel" 
        ? (updatedFormData.digitalReadiness.digitalLevel === 0) 
        : (value.trim().length < 3 && name === "companyPurpose") ? true : false,
    }))
              ...
              <div className="flex-1">
                ...
                <select
                  ...
                  className={`w-full p-2 bg-gray-800 text-white rounded
                    ${errors.digitalLevel ? "border-2 border-red-500" : "border border-gray-700"}`}
                >
                  <option value="">{page.placeholder ? page.placeholder[language] : "Seçin"}</option>
                ...
                {errors.digitalLevel && (
                  <p className="text-red-500 text-sm mt-1">Bu sahə mütləq doldurulmalıdır.</p>
                )}
              </div>
              ...
              <div className="flex-1 relative">
                ...
                <button
                  ...
                  className={`w-full p-2 bg-gray-800 text-white rounded text-left flex justify-between items-center
                    ${errors.digitalTools ? "border-2 border-red-500" : "border border-gray-700"}`}
                >
                  <span>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        let updatedKeyChallenges = checked
                          ...
                          : formData.digitalReadiness.keyChallenges.filter(c => c !== value)
                        const updatedFormData = {
                          ...formData,
                          digitalReadiness: {
                            ...formData.digitalReadiness,
            ...
            <div>
              ...
              <textarea
                ...
                className={`w-full p-4 bg-gray-800 text-white rounded
                  ${errors.companyPurpose ? "border-2 border-red-500" : "border border-gray-700"}`}
                rows={4}
              ...
              {errors.companyPurpose && (
                <p className="text-red-500 text-sm mt-1">Bu sahə mütləq doldurulmalıdır və ən azı 3 simvol olmalıdır.</p>
              )}
            </div>
          </form>
