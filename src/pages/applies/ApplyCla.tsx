...
//             const hasPropertyLawFile = formData.files.propertyLawCertificate !== null;
//             const hasFinancialStatementFile = formData.files.financialStatement !== null;

//             // Check file types
//             const propertyFileTypeValid = hasPropertyLawFile
//                 ? allowedFileType.includes(formData.files.propertyLawCertificate?.type as string)
//                 : false;

//             const financialFileTypeValid = hasFinancialStatementFile
//                 ? allowedFileType.includes(formData.files.financialStatement?.type as string)
//                 : true; // Optional file, so valid if not uploaded

//             // Check file sizes (max 20MB)
//             const propertyFileSizeValid = hasPropertyLawFile
//                 ? (formData.files.propertyLawCertificate?.size || 0) < 20000000
//                 : false;

//             const financialFileSizeValid = hasFinancialStatementFile
//                 ? (formData.files.financialStatement?.size || 0) < 20000000
//                 : true; // Optional file, so valid if not uploaded
...
//             const isValid =
//                 hasPropertyLawFile &&
//                 propertyFileTypeValid &&
//                 propertyFileSizeValid &&
//                 financialFileTypeValid &&
//                 financialFileSizeValid &&
...
//         setErrors(errors);
//         return Object.keys(errors).length === 0 && !!captchaToken;
//     };
...
//                                 className="bg-gray-600 text-white py-3 px-8 rounded-lg hover:bg-gray-700 transition font-medium"
//                             >
//                                 Back
//                             </button>
...
//                                 className={`py-3 px-8 rounded-lg font-medium transition ${isFormValid && !localIsSubmitting
