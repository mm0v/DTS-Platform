...
export default function ApplyTwo() {
  ...
  const handleGoBack = () => {
    navigate('/apply') // /apply sayfasına yönlendir
  }
    ...
    <div className="relative min-h-screen w-full text-white flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-2xl space-y-6 relative z-20">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              <input
                ...
                value="Bəli"
                onChange={handleInputChange}
                checked={formData.exportActivity === "Bəli"}
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                value="Xeyr"
                onChange={handleInputChange}
                checked={formData.exportActivity === "Xeyr"}
                className="text-blue-500"
              />
        ...
        <div className="flex justify-between mt-6">
          <button
            className="w-[48%] bg-gray-600 text-white py-3 rounded-lg transition duration-300"
