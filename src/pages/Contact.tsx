  ...
  return (
    <div className="mt-24">
      ...
      <div
        style={{
          background:
            "linear-gradient(180deg, rgba(35, 42, 96, 0.90) -4.83%, rgba(0, 0, 0, 0.00) 102.71%), var(--surface-white-primary, #FFF)",
        }}
      >
        <div className="w-full max-w-6xl mx-auto px-4 py-12">
          <div className="w-full flex flex-col items-center">
            <div className="w-full bg-slate-900 text-white flex justify-center items-center text-center rounded-lg shadow-lg overflow-hidden mb-8">
              <div className="p-6 md:p-8 flex flex-col space-y-4">
                ...
                <div className="flex items-center justify-center space-x-3">
                  ...
                  <a
                    href="mailto:office@4sim.gov.az"
            ...
            <div className="w-full h-64 md:h-96 rounded-lg overflow-hidden shadow-lg relative">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2889.1871836112623!2d49.85043177582512!3d40.3737646714466!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40307dabc3b06953%3A0x64d0daa228312c9e!2sThe%20Azerbaijan%20Government%20House!5e1!3m2!1sen!2saz!4v1746639197195!5m2!1sen!2saz"
                width="1200"
                height="450"
                loading="lazy"
              ></iframe>
