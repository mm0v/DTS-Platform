  ...
  return (
    <div
      ...
      className={`bg-white rounded-lg p-6 m-4 shadow-[2px_2px_12px_0px_#2323234D] border-[1px] border-[#D0D0D0] flex flex-col transition-all duration-300 ease-in-out overflow-hidden ${
        isExpanded ? "max-h-[1000px]" : "max-h-[260px]"
      }`}
    >
      <div className="flex flex-col items-center justify-center text-center">
        <div className="h-[100px] flex items-center justify-center"></div>
        <div className="mt-6 relative">
          <p
            className={`font-normal text-16 text-[#323232] text-center transition-all duration-300 ease-in-out ${
              isExpanded
